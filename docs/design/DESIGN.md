...
采用克制的新粗野主义（Neo-Brutalism）风格：绿色品牌元素、清晰边界和小幅硬偏移阴影。浅色主题以淡米黄画布和暖白表面为主；深色主题以中性炭灰和灰色表面为主。绿色集中用于品牌、主要操作与选中状态。
...
主要表面与控件使用 3px 主题色边框；具体编辑区等局部控件可按组件规则调整。边框使用主题中性灰，不将黑色边框直接搬到深色主题。圆角按用途统一：选中项与小图片框约 8px，主按钮与内容表面约 12px，浮层与输入区域按需要使用至 16px。普通输入框不做成胶囊形；独立图标按钮可使用圆形。
...
| 语义角色 | 浅色主题 | 深色主题 | 用途 |
| --- | --- | --- | --- |
| 画布 | `#F8FAE4` | `#1E1E1E` | 页面与学习画布 |
| 内容表面 | `#FFFEF8` | `#252526` | 阅读、账号和教学区域 |
| 辅助表面 | `#F4F0E6` | `#333335` | 少量辅助分区 |
| 品牌绿 | `#286443` | `#9BD3A9` | 品牌强调与结构元素 |
| 柔和品牌绿 | `#E0EBD8` | `#293E31` | 选中导航和次要强调 |
| 正文 | `#30352F` | `#E7E7E2` | 正文、标题与图标 |
| 次要文字 | `#62685E` | `#B3B5AE` | 辅助信息 |
| 边界 | `#878D7D` | `#777B75` | 分隔线和控件边界 |
